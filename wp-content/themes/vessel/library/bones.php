...
function bones_excerpt_more($more) {
	...
	return '...  <br /><br /><a class="btn btn-sm btn-default excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __( 'Read', 'bonestheme' ) . get_the_title($post->ID).'">'. __( 'Read more &raquo;', 'bonestheme' ) .'</a>';
}
